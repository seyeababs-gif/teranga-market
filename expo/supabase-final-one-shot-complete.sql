-- ============================================
-- ULTIMATE ONE SHOT FIX - VERSION FINALE COMPLÈTE
-- ============================================
-- Ce script gère TOUTES les erreurs possibles

-- ==========================================
-- ÉTAPE 0: CRÉER LES TYPES MANQUANTS
-- ==========================================
...
-- Mettre à jour le type de la colonne status si elle utilise TEXT
DO $$
BEGIN
  -- Convertir status de TEXT à product_status
  IF EXISTS (
...
-- S'assurer que orders a le bon type status
DO $$
BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns 
